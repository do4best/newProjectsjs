        ...
        <>
            <main className="d-flex align-content-center container mt-3 vh-100 mt-5">
                <div className="d-flex flex-column gap-5">
                    ...
                    <p className={"fw-bold "}>YOUR FEET DESERVE THE BEST AND WE ARE HERE TO HELP YOU WITH OUR SHOES. YOUR FEET DESERVE THE BEST AND WE ARE HERE TO HELP YOU WITH OUR SHOES.</p>
